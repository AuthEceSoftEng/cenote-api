define({ "api": [
  ...
  {
    "type": "get",
    "url": "/projects/:PROJECT_ID/queries/eeris/historical",
    "title": "Historical Aggregates for eeRIS",
    "version": "0.1.0",
    "name": "historical",
    "group": "Queries",
    "parameter": {
    ...
    "error": {
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "EventCollectionNotProvidedError",
            "description": "<p>The <code>event_collection</code> parameter must be provided.</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "TypeNotProvidedError",
            "description": "<p>The <code>type</code> parameter must be provided.</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
      ...
      "examples": [
        ...
        {
          "title": "EventCollectionNotProvidedError:",
          "content": "HTTP/1.1 404 Not Found\n{\n  \"error\": \"EventCollectionNotProvidedError\"\n}",
          "type": "json"
        },
        {
          "title": "TypeNotProvidedError:",
